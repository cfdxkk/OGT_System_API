...
public class AsynchronousGroupMessageSender implements FutureCallback<HttpResponse> {
    ...
    public void setUserauthservice(UserAuthService userauthservice){
        AsynchronousGroupMessageSender.userauthservice = userauthservice;
    }
    ...
    public boolean sentMessageToGroupUser (
            String groupIdFrom, String uuidFrom, String usernameFrom, String uuidTo, String messageIDInGroup, String token, String messageType, String message
        ){
        // 检查来源用户是否是合法用户
        if (userauthservice.userAuthCheck(uuidFrom,token)){
            ...
            try {
                ...
                for (String wsServerAddress : this.wsServerAddressMap.keySet()) {
                    ...
                    urlbuilder.setParameter("usernameFrom", usernameFrom);
